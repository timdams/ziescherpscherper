...
c.txt(x + w + 60, 235, 'Bovenkant', 36, C.GRAY, 600, 'start');
...
c.arrow(225, 370, 600, 245, { strokeWidth: 2.4 });

// doelvakje rechts + Pop() (label boven de pijl, rechts van de container)
c.rect(1240, 300, 140, 140);
c.txt(1010, 285, 'Pop()', 36, C.GRAY, 700);
c.arrow(760, 245, 1235, 370, { strokeWidth: 2.4 });
