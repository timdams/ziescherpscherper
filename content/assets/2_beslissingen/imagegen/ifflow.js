// H4 - ifflow: if zonder accolades-blok; "Ja" conditioneel, "Nee" altijd
...
proc(c, X, 570, 400, 72, 'Schrijf "Ja"');
// merge tussen Ja en Nee
c.line(X, 607, X, 650, { strokeWidth: 2.6 });
c.arrow(X, 650, X, 684, { strokeWidth: 2.6, head: 15 });

proc(c, X, 720, 400, 72, 'Schrijf "Nee"');
c.arrow(X, 757, X, 793, { strokeWidth: 2.6, head: 15 });
terminal(c, X, 815);

// false-tak rechtsom, sluit aan voor "Nee"
