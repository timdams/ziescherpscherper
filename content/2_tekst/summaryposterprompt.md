...
- String interpolatie met $"..." en accolades (bv. $"Ik ben {naam} en ik ben {leeftijd} jaar.") is de moderne, leesbare vervanger van strings aan elkaar plakken met de +-operator
- Bij de +-operator bepaalt de volgorde het resultaat: "1"+1+1 geeft "111", maar 1+1+"1" geeft "21"
