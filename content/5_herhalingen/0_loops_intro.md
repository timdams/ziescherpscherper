...
Daarnaast zullen we in hoofdstuk 12 een speciale loopvariant leren kennen wanneer we arrays en objecten bespreken:
...
[^foreachlater]: De ``foreach`` nemen we hier enkel voor de volledigheid al even op in de tabel. We leren deze pas echt gebruiken in hoofdstuk 12, wanneer we met arrays en objecten werken. Trek je er voorlopig dus nog niets van aan.
