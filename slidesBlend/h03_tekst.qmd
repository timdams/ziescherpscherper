...
Een `char` bewaart een getal: `A` = 65, `B` = 66. De `+`-operator bestaat niet voor `char`, dus [C#]{.cs} rekent met `int`: 65 + 66 = **131**.
...
::: {.column width="78%"}
[C#]{.cs} leren lijkt in het begin soms saai, daarom strooi ik er af en toe iets geavanceerds tussen. Niemand kent élke bibliotheek: het is aan jou om te ontdekken welke nuttig zijn voor jouw probleem.
:::
