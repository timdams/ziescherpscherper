...
* [C#]{.cs} lijkt als twee druppels water op **Java**, en stamt af van C en C++
...
::: {.column width="65%"}
De Deen die [C#]{.cs} boven de doopvont hield bij Microsoft.
...
* **Toegankelijk**: je maakt snel iets werkends
* **Microsoft-ecosysteem**: Azure, Office, Power Platform, ... dus stevige ondersteuning
* **Cross-platform**: Windows, Linux, macOS, zelfs een Raspberry Pi
* **Games**: de **Unity**-engine draait op [C#]{.cs}
* **Gegeerd op de arbeidsmarkt**: ruim 1500 openstaande [C#]{.cs}-vacatures in België
* **Proven language**: al 20+ jaar oud en toch elk jaar vernieuwd

::: {.callout-tip .fragment}
[C#]{.cs} hoort bij de C/C++/Java-familie. Wie [C#]{.cs} kent, stapt later vlot over naar verwante talen.
:::

---

## Games gemaakt met [C#]{.cs}

<div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:14px; margin-top:6px;">
  <img src="assets/h01/fallguys.png"  style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
  <img src="assets/h01/amongus.png"   style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
  <img src="assets/h01/stardew.jpg"   style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
  <img src="assets/h01/pokemongo.jpg" style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
  <img src="assets/h01/kerbal.jpg"    style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
  <img src="assets/h01/cuphead.png"   style="width:100%; height:150px; object-fit:cover; border-radius:10px;">
</div>

Allemaal gebouwd met **[C#]{.cs}**, vaak via de **Unity**-engine.
...
De kern: **[C#]{.cs}-code omzetten naar een uitvoerbaar bestand in machinetaal**.
...
* Je [C#]{.cs}-code wordt eerst omgezet naar **Intermediate Language (IL)**
* Bij het uitvoeren zet de CLR die IL **Just-In-Time (JIT)** om naar machinetaal
* Daardoor kunnen .NET-talen ([C#]{.cs}, F#, VB.NET) samenwerken met diezelfde bibliotheken
:::

---

## Naamgeving van .NET en [C#]{.cs}
...
* Elke .NET-versie komt met een nieuwe **[C#]{.cs}-versie** (features die je *kan*, niet *moet* gebruiken)
...
::: {.callout-tip .fragment}
Even snel iets uittesten zonder installatie? Op [dotnetfiddle.net](https://dotnetfiddle.net) programmeer je rechtstreeks in de browser.
:::
...
* Projecttype **Console App** met het **groene [C#]{.cs}-icoon** (niet Visual Basic)
...
* De **compiler** vertaalt je [C#]{.cs} naar machinetaal; **.NET** levert het framework
...
**JavaScript** wordt geinterpreteerd: het draait tot het op een fout botst.
