...
import { DUUR as REEL_ONDERTITELS_DUUR, ReelOndertitels } from "./reels/h18-ondertitels/ReelOndertitels";
  ...
  return (
    <>
      ...
      <Folder name="Reels">
        ...
        <Composition id="Reel-ondertitels" component={ReelOndertitels} durationInFrames={REEL_ONDERTITELS_DUUR} {...STAAND} />
      </Folder>
    </>
  );
};
